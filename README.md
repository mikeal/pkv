...
This gives us, the **public**, the right to build whatever systems we want describing the digital world ***as it appears***. Anything already viewable, including everything on The Web, can be used as a data source without any permission granted from the owner, because all you're doing is cryptographically describing what is in common public view *as it appears in public view*.
